      ...
      return (
        ...
        if(timezone >= 0){
          return (
            ...
            <div className="col-12 col-sm-12">Current Time: <span style={{color: 'yellow'}}>
              {<Moment add={{ seconds: timezone }}>{date}</Moment>} </span> </div>
          ...
          return (
            ...
            <div style={{background: 'rgba(0,106,221,0.1)', borderRadius: '3%'}} >
            <div className="col-12 col-sm-12">Current Time: <span style={{color: 'yellow'}}>
              {<Moment subtract={{ seconds: timezone }}>{date}</Moment>} </span> </div>
